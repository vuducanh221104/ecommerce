...
import { SearchOutlined, MoreOutlined, SendOutlined, DeleteOutlined } from '@ant-design/icons';
...
function Chat({ role = 'admin' }) {
    ...
    const handleJoinRoom = (clickRoomName) => {
        ...
        // Fetch chat history
        axios
            .get(`http://localhost:4000/chat-history/${clickRoomName}`)
            .then((response) => {
    ...
    const handleDeleteAll = () => {
        axios
            .delete('http://localhost:4000/deleteAllRooms')
            .then(() => {
                setActiveRooms([]);
                setAvatar(null);
                setFullname('');
    ...
    const handleDeleteRoom = () => {
        axios
            .delete('http://localhost:4000/deleteRoomm', { data: { roomName, avatar, fullname } })
            .then(() => {
                axios
                    .get('http://localhost:4000/activeRooms')
                    .then((response) => {
