...
function EditDetailProduct({ recordSlug, forwardedRef, productValid, setDetailValid, name, price, price_prepay }) {
    ...
    useEffect(() => {
        const fetchApi = () => {
            axios
                .get(`http://localhost:4000/api-product/product/${recordSlug}`)
                .then((res) => {
                    setId(res.data._id);
                    formik.setValues({
                        name: res.data.name,
                        ...
                        subcategorySlug: res.data.subcategory_slug,
                    });
                })
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (formik.isValid && productValid) {
                ...
                await axios.patch(`http://localhost:4000/api-product/product-details-update/${id}`, {
                    name: name,
                    price: price,
