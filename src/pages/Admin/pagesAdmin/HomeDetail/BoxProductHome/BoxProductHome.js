...
function BoxProductHome() {
    ...
    useEffect(() => {
        axios
            .get('http://localhost:4000/api-image/image/image-theme')
            .then((res) => {
                formik.setValues({
    ...
    const editInputBoxProduct = (formikValuesData, nameValue, index, indexBoxProduct) => {
        ...
        formik.setFieldValue(nameValue, updatedImages);
        console.log(formik.values.container);
    };
    ...
    const handleSubmit = async () => {
        if (formik.isValid) {
            ...
            try {
                ...
                const dataImageThumb = await axios.post('http://localhost:4000/api/admin/upload/uploadCloud', formData);
                ...
                const dataImageBox = await axios.post(
                ...
                await axios.patch('http://localhost:4000/api-image/admin/image/imageHome', {
