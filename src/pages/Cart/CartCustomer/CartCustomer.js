                        ...
                        <div className={cx('choose-check-box__list')}>
                            <div className={cx('form-check')}>
                                <input
                                    ...
                                    checked={isCheckedAtStore ? 'checked' : null}
                                    onClick={() => handleCheckBox()}
                                />
                                <label className={cx('form-check-label')} for="flexRadioDefault1">
                                    Nhận Tại Cửa Hàng
                                </label>
                            </div>
                            <div className={cx('form-check')}>
                                ...
                                />
                                <label className={cx('form-check-label')} for="flexRadioDefault2">
                                    Giao Hàng Tận Nơi
                                </label>
                            </div>
                        </div>
