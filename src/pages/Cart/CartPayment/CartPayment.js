        ...
        switch (selectedPaymentMethod) {
                ...
                (async () => {
                    try {
                        const response = await axios.post(
                            'http://localhost:4000/api-payment/payment/create-payment-vnpay',
                            {
                                dataToSend,
                            },
                        );
            ...
            case 'atZaloPay':
                ...
                (async () => {
                    try {
                        const response = await axios.post(
                            'http://localhost:4000/api-payment/payment/create-payment-zalopay',
                            {
                                dataToSendZalopay,
                            },
                        );
            ...
            case 'atMomo':
                ...
                (async () => {
                    try {
                        const response = await axios.post(
                            'http://localhost:4000/api-payment/payment/create-payment-momo',
                            {
                                dataToSendMomo,
                            },
                        );
                                ...
                                product.map((data, index) => (
                                    <div className={cx('description-list')}>
                                        ...
                                        {data.products.map((item) => (
                                            <>
                                                <ul className={cx('endow-list')} style={{ padding: '0' }}>
