...
import CategoryProduct from '~/pages/Admin/pagesAdmin/Products/CategoryProduct';
...
const publicRoutes = [
    ...
    { path: config.routesAdmin.categoryProduct, component: CategoryProduct, layout: LayoutAdmin },
